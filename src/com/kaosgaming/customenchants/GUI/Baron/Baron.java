package com.kaosgaming.customenchants.GUI.Baron;
...
public class Baron implements CommandExecutor {
	...
	public boolean onCommand(CommandSender sender, Command cmd,
		...
		Inventory inv = Bukkit.createInventory(null, 27, ChatColor.RED + "               [Baron] Rank!");
		...
		ItemStack PvPp = nameItem(Material.IRON_SWORD, ChatColor.RED + "PvPb");
		inv.setItem(12, PvPp);
		
		ItemStack stainedGlass13 = nameItem(Material.STAINED_GLASS_PANE, ChatColor.BLACK + "");
		inv.setItem(13, stainedGlass13);
		
		ItemStack peasantKit = nameItem(Material.IRON_PICKAXE, ChatColor.RED + "[Baron] Kit");
