package com.kaosgaming.customenchants.GUI.King;
...
public class King implements CommandExecutor {
	...
	public boolean onCommand(CommandSender sender, Command cmd,
		...
		Inventory inv = Bukkit.createInventory(null, 27, ChatColor.GOLD + "               [King] Rank!");
		...
		ItemStack PvPp = nameItem(Material.EMERALD_BLOCK, ChatColor.GOLD + "PvPkg");
		inv.setItem(12, PvPp);
		
		ItemStack stainedGlass13 = nameItem(Material.STAINED_GLASS_PANE, ChatColor.BLACK + "");
		inv.setItem(13, stainedGlass13);
		
		ItemStack peasantKit = nameItem(Material.EMERALD_ORE, ChatColor.GOLD + "[King] Kit");
