package com.kaosgaming.customenchants.GUI.Knight;
...
public class Knight implements CommandExecutor {
	...
	public boolean onCommand(CommandSender sender, Command cmd,
		...
		Inventory inv = Bukkit.createInventory(null, 27, ChatColor.BLUE + "               [Knight] Rank!");
		...
		ItemStack PvPp = nameItem(Material.STONE_SWORD, ChatColor.BLUE + "PvPk");
		inv.setItem(12, PvPp);
		
		ItemStack stainedGlass13 = nameItem(Material.STAINED_GLASS_PANE, ChatColor.BLACK + "");
		inv.setItem(13, stainedGlass13);
		
		ItemStack peasantKit = nameItem(Material.STONE_PICKAXE, ChatColor.BLUE + "[Knight] Kit");
