package com.kaosgaming.customenchants.GUI.Peasant;
...
public class Peasant implements CommandExecutor, Listener {
	...
	public boolean onCommand(CommandSender sender, Command cmd,
		...
		Inventory inv = Bukkit.createInventory(null, 27, ChatColor.AQUA + "            [Peasant] Rank!");
		...
		ItemStack PvPp = nameItem(Material.WOOD_SWORD, ChatColor.AQUA + "PvPp");
		inv.setItem(12, PvPp);
		
		ItemStack stainedGlass13 = nameItem(Material.STAINED_GLASS_PANE, ChatColor.BLACK + "");
		inv.setItem(13, stainedGlass13);
		
		ItemStack peasantKit = nameItem(Material.WOOD_PICKAXE, ChatColor.AQUA + "[Peasant] Kit");
