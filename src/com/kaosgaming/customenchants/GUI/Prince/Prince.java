package com.kaosgaming.customenchants.GUI.Prince;
...
public class Prince implements CommandExecutor {
	...
	public boolean onCommand(CommandSender sender, Command cmd,
		...
		Inventory inv = Bukkit.createInventory(null, 27, ChatColor.LIGHT_PURPLE + "               [Prince] Rank!");
		...
		ItemStack PvPp = nameItem(Material.DIAMOND_SWORD, ChatColor.LIGHT_PURPLE + "PvPpr");
		inv.setItem(12, PvPp);
		
		ItemStack stainedGlass13 = nameItem(Material.STAINED_GLASS_PANE, ChatColor.BLACK + "");
		inv.setItem(13, stainedGlass13);
		
		ItemStack peasantKit = nameItem(Material.DIAMOND_PICKAXE, ChatColor.LIGHT_PURPLE + "[Prince] Kit");
